...
prompt *********************************************************************************
prompt
prompt Creating development objects in the following schemas:
prompt
...
as
    select date '2015-01-01' + mod(rownum,10)                                                                               as time_id
    ,      prod_id
    ,      cust_id
    ,      channel_id
    ,      promo_id
    ...
    ,      cast(date '2015-01-01' + mod(rownum,10) as timestamp(6)) + numtodsinterval(dbms_random.value(1,60000), 'second') as load_ts
    ,      quantity_sold
    ,      amount_sold
    from   sales
;
