...
from goe.goe import init_log, version, get_log_fh_name, log_command_line, log_timestamp, init, log, get_log_fh, \
...
ORDER  BY
       o.offloaded_owner
,      o.offloaded_table""".format(goe_adm_schema=self._ora_adm_user)
...
,      s.table_subpartition_position"""
    ...
    def _get_demo_table_data(self):
        ...
        if (self._schema is None) or (self._schema.upper() == 'SH'):
            if (self._table is None) or (self._table.upper() == 'COSTS'):
                table_data.append({'HYBRID_VIEW_TYPE': 'GOE_OFFLOAD_HYBRID_VIEW', 'OFFLOAD_PART_KEY': 'offload_bucket_id, goe_part_m_time_id', 'HYBRID_VIEW': 'COSTS', 'HYBRID_EXTERNAL_TABLE': 'COSTS_EXT', 'SOURCE_OWNER': 'SH', 'OFFLOAD_BUCKET_METHOD': None, 'INCREMENTAL_HIGH_VALUE': "TO_DATE(' 2015-07-01 00:00:00', 'SYYYY-MM-DD HH24:MI:SS', 'NLS_CALENDAR=GREGORIAN')", 'OFFLOAD_OWNER': 'sh', 'SOURCE_TABLE': 'COSTS', 'OFFLOAD_SORT_COLUMNS': None, 'OFFLOAD_PARTITION_FUNCTIONS': 'UDFS.COST2PKEY', 'INCREMENTAL_PREDICATE_TYPE': None, 'INCREMENTAL_PREDICATE_VALUE': None, 'OFFLOAD_TABLE': 'costs', 'OFFLOAD_TABLE_EXISTS': True, '_RECLAIMABLE_PARTS': 229, '_RETAINED_BYTES': 0, '_RETAINED_ROWS': 0, '_OFFLOADED_BYTES': 6113146.879999999, 'OFFLOAD_BUCKET_COLUMN': 'UNIT_COST', 'OFFLOAD_BUCKET_COUNT': '16', '_RECLAIMABLE_ROWS': 1787540, 'INCREMENTAL_UPDATE_METHOD': None, '_RECLAIMABLE_BYTES': 141492224, '_OFFLOADED_ROWS': 1787540, 'OFFLOAD_VERSION': None, 'OFFLOAD_TYPE': 'INCREMENTAL', '_RETAINED_PARTS': 0,  '_OFFLOADED_TABLES': 1, 'INCREMENTAL_RANGE': 'PARTITION', '_OFFLOADED_PARTS': 864, 'INCREMENTAL_KEY': 'TIME_ID', 'HYBRID_OWNER': 'SH_H',
                                   'AAPD_OBJECTS': [{'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'COSTS_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'COSTS_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'COSTS_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'COSTS_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'COSTS_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'COSTS_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'JOIN_OBJECTS_RDBMS': [{'OBJECT_TYPE_GOE': 'JOIN_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_EXT', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'JOIN_OBJECTS_OFFLOAD': [{'OBJECT_TYPE_GOE': 'JOIN_TABLE', 'OBJECT_OWNER': 'sh', 'OBJECT_NAME': 'sales_costs', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'sh', 'OBJECT_NAME': 'sales_costs_promos', 'OBJECT_TYPE_DB': 'VIEW'}],
                                   'INCREMENTAL_UPDATE_OBJECTS_RDBMS': [],
                                   'INCREMENTAL_UPDATE_OBJECTS_OFFLOAD': [],
                                   'DEPENDENT_OBJECTS': [{'OBJECT_TYPE_GOE': 'DEPENDENT_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'PROFITS', 'OBJECT_TYPE_DB': 'VIEW'}]})
                self._messages.debug('Added SH.COSTS to demo dataset')
            if (self._table is None) or (self._table.upper() == 'CUSTOMERS'):
                table_data.append({'HYBRID_VIEW_TYPE': 'GOE_OFFLOAD_HYBRID_VIEW', 'OFFLOAD_PART_KEY': 'offload_bucket_id', '_RECLAIMABLE_PARTS': 1, 'HYBRID_VIEW': 'CUSTOMERS', 'HYBRID_EXTERNAL_TABLE': 'CUSTOMERS_EXT', 'SOURCE_OWNER': 'SH', '_OFFLOADED_BYTES': 2296381.4400000004, 'OFFLOAD_BUCKET_METHOD': 'GOE_BUCKET', 'OFFLOAD_OWNER': 'sh', 'SOURCE_TABLE': 'CUSTOMERS', '_RETAINED_ROWS': 0, 'OFFLOAD_SORT_COLUMNS': None, 'OFFLOAD_PARTITION_FUNCTIONS': None, 'INCREMENTAL_PREDICATE_TYPE': None, 'INCREMENTAL_PREDICATE_VALUE': None, '_RETAINED_BYTES': 0, 'INCREMENTAL_HIGH_VALUE': None, 'OFFLOAD_TABLE_EXISTS': True, 'OFFLOAD_TABLE': 'customers', 'INCREMENTAL_UPDATE_METHOD': None, '_RECLAIMABLE_BYTES': 12582912, '_OFFLOADED_ROWS': 55500, 'OFFLOAD_VERSION': '2.9.0', 'OFFLOAD_TYPE': 'FULL', '_RETAINED_PARTS': 0, '_RECLAIMABLE_ROWS': 55500, '_OFFLOADED_TABLES': 1, 'INCREMENTAL_RANGE': None, '_OFFLOADED_PARTS': 2, 'INCREMENTAL_KEY': None, 'HYBRID_OWNER': 'SH_H',
                                   'AAPD_OBJECTS': [{'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMERS_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMERS_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMERS_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMERS_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMERS_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMERS_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTS_BY_GENDER', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTS_BY_GENDER', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTS_BY_GENDER_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUST_BY_COUNTRY', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUST_BY_COUNTRY', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUST_BY_COUNTRY_EXT', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'JOIN_OBJECTS_RDBMS': [{'OBJECT_TYPE_GOE': 'JOIN_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMER_COUNTRIES', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMER_COUNTRIES', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMER_COUNTRIES_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMER_COUNTRIES_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMER_COUNTRIES_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMER_COUNTRIES_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMER_COUNTRIES_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMER_COUNTRIES_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUSTOMER_COUNTRIES_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUST_COUNTRY_JOIN', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUST_COUNTRY_JOIN', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUST_COUNTRY_JOIN_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUST_COUNTRY_JOIN_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUST_COUNTRY_JOIN_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUST_COUNTRY_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUST_COUNTRY_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUST_COUNTRY_JOIN_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'CUST_COUNTRY_JOIN_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_CNT__KYE2', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_EXT', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'JOIN_OBJECTS_OFFLOAD': [{'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'sh', 'OBJECT_NAME': 'cust_country_join', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_TABLE', 'OBJECT_OWNER': 'sh', 'OBJECT_NAME': 'salescountry_join', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_TABLE', 'OBJECT_OWNER': 'sh', 'OBJECT_NAME': 'sales_cust_prod_join', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'INCREMENTAL_UPDATE_OBJECTS_RDBMS': [],
                                   'INCREMENTAL_UPDATE_OBJECTS_OFFLOAD': [],
                                   'OFFLOAD_BUCKET_COLUMN': 'CUST_ID', 'OFFLOAD_BUCKET_COUNT': '2',
                                   'DEPENDENT_OBJECTS': [{'OBJECT_TYPE_GOE': 'DEPENDENT_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'GOE_SALES_100_JOIN_DV', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'DEPENDENT_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'GOE_SALES_JOIN_DV', 'OBJECT_TYPE_DB': 'VIEW'}]})
                self._messages.debug('Added SH.CUSTOMERS to demo dataset')
            if (self._table is None) or (self._table.upper() == 'SALES'):
                table_data.append({'HYBRID_VIEW_TYPE': 'GOE_OFFLOAD_HYBRID_VIEW','OFFLOAD_BUCKET_COLUMN': 'ID', 'OFFLOAD_BUCKET_COUNT': '1', 'OFFLOAD_PART_KEY': 'offload_bucket_id, goe_part_m_time_id', '_RECLAIMABLE_PARTS': 36, 'HYBRID_VIEW': 'SALES', 'HYBRID_EXTERNAL_TABLE': 'SALES_EXT', 'SOURCE_OWNER': 'SH', '_OFFLOADED_BYTES': 22473584.640000004, 'OFFLOAD_BUCKET_METHOD': 'GOE_BUCKET', 'OFFLOAD_OWNER': 'sh', 'SOURCE_TABLE': 'SALES', '_RETAINED_ROWS': 978554, 'OFFLOAD_SORT_COLUMNS': None, 'INCREMENTAL_PREDICATE_TYPE': None, 'INCREMENTAL_PREDICATE_VALUE': None, 'OFFLOAD_PARTITION_FUNCTIONS': None, '_RETAINED_BYTES': 198049792, 'INCREMENTAL_HIGH_VALUE': "TO_DATE(' 2014-01-01 00:00:00', 'SYYYY-MM-DD HH24:MI:SS', 'NLS_CALENDAR=GREGORIAN')", 'OFFLOAD_TABLE_EXISTS': True, 'OFFLOAD_TABLE': 'sales', '_RECLAIMABLE_ROWS': 1944973, 'INCREMENTAL_UPDATE_METHOD': None, '_RECLAIMABLE_BYTES': 232062976, '_OFFLOADED_ROWS': 1888830, 'OFFLOAD_VERSION': '2.11.0', 'OFFLOAD_TYPE': 'INCREMENTAL', '_RETAINED_PARTS': 193, '_OFFLOADED_TABLES': 1, 'INCREMENTAL_RANGE': 'PARTITION', '_OFFLOADED_PARTS': 35, 'INCREMENTAL_KEY': 'TIME_ID', 'HYBRID_OWNER': 'SH_H',
                                   'AAPD_OBJECTS': [{'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'JOIN_OBJECTS_RDBMS': [{'OBJECT_TYPE_GOE': 'JOIN_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_COSTS_PROMOS_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_CNT__KYE2', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_CUST_PROD_JOIN_EXT', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'JOIN_OBJECTS_OFFLOAD': [{'OBJECT_TYPE_GOE': 'JOIN_TABLE', 'OBJECT_OWNER': 'sh', 'OBJECT_NAME': 'salescountry_join', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_TABLE', 'OBJECT_OWNER': 'sh', 'OBJECT_NAME': 'sales_costs', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'sh', 'OBJECT_NAME': 'sales_costs_promos', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_TABLE', 'OBJECT_OWNER': 'sh', 'OBJECT_NAME': 'sales_cust_prod_join', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'INCREMENTAL_UPDATE_OBJECTS_RDBMS': [],
                                   'INCREMENTAL_UPDATE_OBJECTS_OFFLOAD': [],
                                   'DEPENDENT_OBJECTS': [{'OBJECT_TYPE_GOE': 'DEPENDENT_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'PROFITS', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'DEPENDENT_VIEW', 'OBJECT_OWNER': 'SH_H', 'OBJECT_NAME': 'SALES_TRICK_VIEW', 'OBJECT_TYPE_DB': 'VIEW'}]})
                self._messages.debug('Added SH.SALES to demo dataset')
        if (self._schema is None) or (self._schema.upper() == 'SH_TEST'):
            if (self._table is None) or (self._table.upper() == 'COSTS'):
                table_data.append({'HYBRID_VIEW_TYPE': 'GOE_OFFLOAD_HYBRID_VIEW', 'OFFLOAD_PART_KEY': 'offload_bucket_id, goe_part_m_time_id', '_RECLAIMABLE_PARTS': 24, 'HYBRID_VIEW': 'COSTS', 'HYBRID_EXTERNAL_TABLE': 'COSTS_EXT', 'SOURCE_OWNER': 'SH_TEST', '_OFFLOADED_BYTES': 3616266.2400000007, 'OFFLOAD_BUCKET_METHOD': None, 'OFFLOAD_OWNER': 'sh_test', 'SOURCE_TABLE': 'COSTS', '_RETAINED_ROWS': 1020075, 'OFFLOAD_SORT_COLUMNS': None, 'INCREMENTAL_PREDICATE_TYPE': None, 'INCREMENTAL_PREDICATE_VALUE': None, 'OFFLOAD_PARTITION_FUNCTIONS': None, '_RETAINED_BYTES': 89063424, 'INCREMENTAL_HIGH_VALUE': "TO_DATE(' 2013-01-01 00:00:00', 'SYYYY-MM-DD HH24:MI:SS', 'NLS_CALENDAR=GREGORIAN')", 'OFFLOAD_TABLE_EXISTS': True, 'OFFLOAD_TABLE': 'costs', 'OFFLOAD_BUCKET_COLUMN': 'UNIT_COST', 'OFFLOAD_BUCKET_COUNT': '16', '_RECLAIMABLE_ROWS': 767465, 'INCREMENTAL_UPDATE_METHOD': None, '_RECLAIMABLE_BYTES': 52428800, '_OFFLOADED_ROWS': 1704070, 'OFFLOAD_VERSION': '2.8.0', 'OFFLOAD_TYPE': 'INCREMENTAL', '_RETAINED_PARTS': 205, '_OFFLOADED_TABLES': 1, 'INCREMENTAL_RANGE': 'PARTITION', '_OFFLOADED_PARTS': 102, 'INCREMENTAL_KEY': 'TIME_ID', 'HYBRID_OWNER': 'SH_TEST_H',
                                   'AAPD_OBJECTS': [{'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'COSTS_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'COSTS_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'COSTS_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'COSTS_BY_TIME', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'COSTS_BY_TIME', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'COSTS_BY_TIME_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'COSTS_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'COSTS_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'COSTS_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'JOIN_OBJECTS_RDBMS': [],
                                   'JOIN_OBJECTS_OFFLOAD': [],
                                   'INCREMENTAL_UPDATE_OBJECTS_RDBMS': [],
                                   'INCREMENTAL_UPDATE_OBJECTS_OFFLOAD': [],
                                   'DEPENDENT_OBJECTS': [{'OBJECT_TYPE_GOE': 'DEPENDENT_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'PROFITS', 'OBJECT_TYPE_DB': 'VIEW'}]})
                self._messages.debug('Added SH_TEST.COSTS to demo dataset')
            if (self._table is None) or (self._table.upper() == 'CUSTOMERS'):
                table_data.append({'HYBRID_VIEW_TYPE': 'GOE_OFFLOAD_HYBRID_VIEW', 'OFFLOAD_PART_KEY': 'offload_bucket_id', '_RECLAIMABLE_PARTS': 1, 'HYBRID_VIEW': 'CUSTOMERS', 'HYBRID_EXTERNAL_TABLE': 'CUSTOMERS_EXT', 'SOURCE_OWNER': 'SH_TEST', '_OFFLOADED_BYTES': 2925885.4400000004, 'OFFLOAD_BUCKET_METHOD': 'GOE_BUCKET', 'OFFLOAD_OWNER': 'sh_test', 'SOURCE_TABLE': 'CUSTOMERS', '_RETAINED_ROWS': 0, 'OFFLOAD_SORT_COLUMNS': None, 'INCREMENTAL_PREDICATE_TYPE': None, 'INCREMENTAL_PREDICATE_VALUE': None, 'OFFLOAD_PARTITION_FUNCTIONS': None, '_RETAINED_BYTES': 0, 'INCREMENTAL_HIGH_VALUE': None, 'OFFLOAD_TABLE_EXISTS': True, 'OFFLOAD_TABLE': 'customers', 'OFFLOAD_BUCKET_COLUMN': 'CUST_ID', 'OFFLOAD_BUCKET_COUNT': '16', '_RECLAIMABLE_ROWS': 55500, 'INCREMENTAL_UPDATE_METHOD': None, '_RECLAIMABLE_BYTES': 14024704, '_OFFLOADED_ROWS': 55500, 'OFFLOAD_VERSION': None, 'OFFLOAD_TYPE': 'FULL', '_RETAINED_PARTS': 0, '_OFFLOADED_TABLES': 1, 'INCREMENTAL_RANGE': None, '_OFFLOADED_PARTS': 16, 'INCREMENTAL_KEY': None, 'HYBRID_OWNER': 'SH_TEST_H',
                                   'AAPD_OBJECTS': [{'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'CUSTOMERS_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'CUSTOMERS_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'CUSTOMERS_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'CUSTOMERS_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'CUSTOMERS_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'CUSTOMERS_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'JOIN_OBJECTS_RDBMS': [{'OBJECT_TYPE_GOE': 'JOIN_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_EXT', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'JOIN_OBJECTS_OFFLOAD': [{'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'sh_test', 'OBJECT_NAME': 'salescountry_join', 'OBJECT_TYPE_DB': 'VIEW'}],
                                   'INCREMENTAL_UPDATE_OBJECTS_RDBMS': [],
                                   'INCREMENTAL_UPDATE_OBJECTS_OFFLOAD': [],
                                   'DEPENDENT_OBJECTS': [{'OBJECT_TYPE_GOE': 'DEPENDENT_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'GOE_CUSTOMERS_MIXED_V1', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'DEPENDENT_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'GOE_CUSTOMERS_MIXED_V2', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'DEPENDENT_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'GOE_SALES_100_JOIN_DV', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'DEPENDENT_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'GOE_SALES_JOIN_DV', 'OBJECT_TYPE_DB': 'VIEW'}]})
                self._messages.debug('Added SH_TEST.CUSTOMERS to demo dataset')
            if (self._table is None) or (self._table.upper() == 'PRODUCTS'):
                table_data.append({'HYBRID_VIEW_TYPE': 'GOE_OFFLOAD_HYBRID_VIEW', 'OFFLOAD_PART_KEY': 'offload_bucket_id', '_RECLAIMABLE_PARTS': 1, 'HYBRID_VIEW': 'PRODUCTS', 'HYBRID_EXTERNAL_TABLE': 'PRODUCTS_EXT', 'SOURCE_OWNER': 'SH_TEST', '_OFFLOADED_BYTES': 68177.92, 'OFFLOAD_BUCKET_METHOD': 'GOE_BUCKET', 'OFFLOAD_OWNER': 'sh_test', 'SOURCE_TABLE': 'PRODUCTS', '_RETAINED_ROWS': 0, 'OFFLOAD_SORT_COLUMNS': None, 'INCREMENTAL_PREDICATE_TYPE': None, 'INCREMENTAL_PREDICATE_VALUE': None, 'OFFLOAD_PARTITION_FUNCTIONS': None, '_RETAINED_BYTES': 0, 'INCREMENTAL_HIGH_VALUE': None, 'OFFLOAD_TABLE_EXISTS': True, 'OFFLOAD_TABLE': 'products', 'OFFLOAD_BUCKET_COLUMN': 'PROD_ID', 'OFFLOAD_BUCKET_COUNT': '16', '_RECLAIMABLE_ROWS': 72, 'INCREMENTAL_UPDATE_METHOD': None, '_RECLAIMABLE_BYTES': 327680, '_OFFLOADED_ROWS': 72, 'OFFLOAD_VERSION': '2.8.0', 'OFFLOAD_TYPE': 'FULL', '_RETAINED_PARTS': 0, '_OFFLOADED_TABLES': 1, 'INCREMENTAL_RANGE': None, '_OFFLOADED_PARTS': 16, 'INCREMENTAL_KEY': None, 'HYBRID_OWNER': 'SH_TEST_H',
                                   'AAPD_OBJECTS': [{'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'PRODUCTS_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'PRODUCTS_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'PRODUCTS_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'PRODUCTS_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'PRODUCTS_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'PRODUCTS_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'JOIN_OBJECTS_RDBMS': [],
                                   'JOIN_OBJECTS_OFFLOAD': [],
                                   'INCREMENTAL_UPDATE_OBJECTS_RDBMS': [],
                                   'INCREMENTAL_UPDATE_OBJECTS_OFFLOAD': [],
            ...
            if (self._table is None) or (self._table.upper() == 'SALES'):
                table_data.append({'HYBRID_VIEW_TYPE': 'GOE_OFFLOAD_HYBRID_VIEW', 'OFFLOAD_PART_KEY': 'offload_bucket_id, goe_part_m_time_id', '_RECLAIMABLE_PARTS': 24, 'HYBRID_VIEW': 'SALES', 'HYBRID_EXTERNAL_TABLE': 'SALES_EXT', 'SOURCE_OWNER': 'SH_TEST', '_OFFLOADED_BYTES': 18300405.760000005, 'OFFLOAD_BUCKET_METHOD': 'GOE_BUCKET', 'OFFLOAD_OWNER': 'sh_test', 'SOURCE_TABLE': 'SALES', '_RETAINED_ROWS': 1641231, 'OFFLOAD_SORT_COLUMNS': None, 'INCREMENTAL_PREDICATE_TYPE': None, 'INCREMENTAL_PREDICATE_VALUE': None, 'OFFLOAD_PARTITION_FUNCTIONS': None, '_RETAINED_BYTES': 204537856, 'INCREMENTAL_HIGH_VALUE': "TO_DATE(' 2013-01-01 00:00:00', 'SYYYY-MM-DD HH24:MI:SS', 'NLS_CALENDAR=GREGORIAN')", 'OFFLOAD_TABLE_EXISTS': True, 'OFFLOAD_TABLE': 'sales', 'OFFLOAD_BUCKET_COLUMN': 'CUST_ID', 'OFFLOAD_BUCKET_COUNT': '16', '_RECLAIMABLE_ROWS': 1282296, 'INCREMENTAL_UPDATE_METHOD': None, '_RECLAIMABLE_BYTES': 104464384, '_OFFLOADED_ROWS': 2784039, 'OFFLOAD_VERSION': '2.8.0', 'OFFLOAD_TYPE': 'INCREMENTAL', '_RETAINED_PARTS': 205, '_OFFLOADED_TABLES': 1, 'INCREMENTAL_RANGE': 'PARTITION', '_OFFLOADED_PARTS': 102, 'INCREMENTAL_KEY': 'TIME_ID', 'HYBRID_OWNER': 'SH_TEST_H',
                                   'AAPD_OBJECTS': [{'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_BY_TIME', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_BY_TIME', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_BY_TIME_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_BY_TIME_PROD', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_BY_TIME_PROD', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_BY_TIME_PROD_CUST_CHAN', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_BY_TIME_PROD_CUST_CHAN', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_BY_TIME_PROD_CUST_C_8OU8', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_BY_TIME_PROD_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALES_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'JOIN_OBJECTS_RDBMS': [{'OBJECT_TYPE_GOE': 'JOIN_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_RULE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'MATERIALIZED VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_VIEW', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_CNT_AGG', 'OBJECT_TYPE_DB': 'VIEW'}, {'OBJECT_TYPE_GOE': 'JOIN_AAPD_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_CNT_AGG_EXT', 'OBJECT_TYPE_DB': 'TABLE'}, {'OBJECT_TYPE_GOE': 'JOIN_EXTERNAL_TABLE', 'OBJECT_OWNER': 'SH_TEST_H', 'OBJECT_NAME': 'SALESCOUNTRY_JOIN_EXT', 'OBJECT_TYPE_DB': 'TABLE'}],
                                   'JOIN_OBJECTS_OFFLOAD': [{'OBJECT_TYPE_GOE': 'JOIN_VIEW', 'OBJECT_OWNER': 'sh_test', 'OBJECT_NAME': 'salescountry_join', 'OBJECT_TYPE_DB': 'VIEW'}],
                                   'INCREMENTAL_UPDATE_OBJECTS_RDBMS': [],
                                   'INCREMENTAL_UPDATE_OBJECTS_OFFLOAD': [],
                    ...
                    def multivalue_subsection(data, data_type, title):
                        if data:
                            ...
                            for o in sorted(data, key=lambda k: k[OBJECT_NAME]):
                                report_data.append(lpad('%-30s %-24s %s' % (o[OBJECT_TYPE_GOE].replace('_', ' ').capitalize(), o[OBJECT_TYPE_DB], self._format_table_name(o[OBJECT_OWNER], o[OBJECT_NAME])), indent))
    ...
    def _gen_html_report(self, data):
        ...
        report_data = [j2_env.get_template('offload_status_report/goe_offload_status_report.html').render(data=data, metadata=self.metadata)]
                        ...
                        if k not in MULTIVALUE_KEYS:
                            ...
                            if len(v) > 0:
                                for n, mv in enumerate(v, 1):
                                    print('   %-50s: %s.%s (%s) (%s)' % ('%s (%s)' % (k, n), mv[OBJECT_OWNER], mv[OBJECT_NAME], mv[OBJECT_TYPE_DB], mv[OBJECT_TYPE_GOE]))
                                print('%s%s' % ('   ', '-' * 30))
                            else:
                                print('   %-50s: %s' % (k, v))
