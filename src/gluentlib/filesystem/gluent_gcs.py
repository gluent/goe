...
from gluentlib.filesystem.gluent_dfs import GluentDfs, GluentDfsDeleteNotComplete, GluentDfsException, gen_fs_uri,\
...
class GluentGcs(GluentDfs):
    ...
    @retry.Retry(predicate=retry.if_exception_type(google_exceptions.GatewayTimeout),
                 deadline=DFS_RETRY_TIMEOUT)
