#! /usr/bin/env python3
""" OffloadTransportNetezzaApi: Library for logic/interaction with source Netezza system during offload transport.
    LICENSE_TEXT
"""
...
class OffloadTransportNetezzaApi(OffloadTransportRdbmsApiInterface):
    """ Netezza specific methods
    """
    ...
    def __init__(self, rdbms_owner, rdbms_table_name, offload_options, messages,
        ...
        self.debug('OffloadTransportNetezzaApi setup: (%s, %s)' % (rdbms_owner, rdbms_table_name))
    ...
    def get_rdbms_query_cast(self, column_expression, rdbms_column, staging_column, max_ts_scale,
        ...
        raise NotImplementedError('Netezza get_rdbms_query_cast() pending implementation')
    ...
    def get_rdbms_session_setup_commands(self, module, action, custom_session_parameters, include_fixed_sqoop=True,
        ...
        raise NotImplementedError('Netezza get_rdbms_session_setup_commands() not implemented.')

    def get_rdbms_session_setup_hint(self, custom_session_parameters, max_ts_scale):
        """ No session setup hints required on Netezza """
        return ''

    def get_rdbms_scn(self):
        raise NotImplementedError('Netezza get_rdbms_scn() not implemented.')
    ...
    def get_transport_row_source_query(self, partition_by_prm, rdbms_table, consistent_read, parallelism,
        ...
        raise NotImplementedError('Netezza get_transport_row_source_query() not implemented.')

    def get_transport_row_source_query_hint_block(self) -> str:
        raise NotImplementedError('Netezza get_transport_row_source_query_hint_block() not implemented.')

    def log_sql_stats(self, module, action, payload,
                      validation_polling_interval=OFFLOAD_TRANSPORT_VALIDATION_POLLER_DISABLED):
        raise NotImplementedError('Netezza log_sql_stats() not implemented.')
    ...
    def jdbc_url(self):
        return '"jdbc:netezza://' + self._offload_transport_dsn + '"'
    ...
    def query_import_extraction(self, staging_columns, source_query, source_binds,
        ...
        raise NotImplementedError('Netezza query_import_extraction() not implemented')
    ...
    def sqoop_rdbms_specific_table_options(self, rdbms_owner, table_name) -> list:
        return ['--table', self._ssh_cli_safe_value(table_name)]
