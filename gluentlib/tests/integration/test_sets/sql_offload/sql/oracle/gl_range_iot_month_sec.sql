...
create table gl_range_iot_month_sec
( id   integer
, data varchar2(30)
, dt   date
, constraint gl_range_iot_month_sec_pk
    primary key (id, dt)
)
organization index
...
create index gl_range_iot_month_sec_ix
   on gl_range_iot_month_sec(dt)
   local
;

insert into gl_range_iot_month_sec
   ( id, data, dt )
select rownum
