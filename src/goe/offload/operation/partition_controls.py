...
from goe.offload.offload_source_table import OFFLOAD_PARTITION_TYPE_HASH, OFFLOAD_PARTITION_TYPE_LIST
from goe.offload.oracle.oracle_column import ORACLE_TYPE_INTERVAL_DS, ORACLE_TYPE_INTERVAL_YM
