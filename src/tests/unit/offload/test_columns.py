...
class TestColumns(TestCase):
    ...
    def test_oracle_column(self):
        for data_type in [
            (ORACLE_TYPE_CHAR, 5, None, None),
            (ORACLE_TYPE_NCHAR, 5, None, None),
            ORACLE_TYPE_CLOB,
            ORACLE_TYPE_NCLOB,
            ORACLE_TYPE_LONG,
            (ORACLE_TYPE_VARCHAR2, 30, None, None),
            (ORACLE_TYPE_NVARCHAR2, 30, None, None),
            ORACLE_TYPE_RAW,
            (ORACLE_TYPE_RAW, 16, None, None),
            ORACLE_TYPE_BLOB,
            ORACLE_TYPE_LONG_RAW,
            ORACLE_TYPE_NUMBER,
            (ORACLE_TYPE_NUMBER, None, 12, None),
            (ORACLE_TYPE_NUMBER, None, 20, 2),
            ORACLE_TYPE_FLOAT,
            ORACLE_TYPE_BINARY_FLOAT,
            ORACLE_TYPE_BINARY_DOUBLE,
            ORACLE_TYPE_DATE,
            ORACLE_TYPE_TIMESTAMP,
            (ORACLE_TYPE_TIMESTAMP, None, None, 3),
            ORACLE_TYPE_TIMESTAMP_TZ,
            (ORACLE_TYPE_TIMESTAMP_TZ, None, None, 3),
            ORACLE_TYPE_INTERVAL_DS,
            ORACLE_TYPE_INTERVAL_YM,
        ]:
            if isinstance(data_type, tuple):
    ...
    def test_snowflake_column(self):
        for data_type in [
            SNOWFLAKE_TYPE_BINARY,
            (SNOWFLAKE_TYPE_BINARY, 16, None, None),
            SNOWFLAKE_TYPE_BOOLEAN,
            SNOWFLAKE_TYPE_DATE,
            SNOWFLAKE_TYPE_FLOAT,
            SNOWFLAKE_TYPE_NUMBER,
            (SNOWFLAKE_TYPE_NUMBER, None, 12, None),
            (SNOWFLAKE_TYPE_NUMBER, None, 20, 2),
            SNOWFLAKE_TYPE_TEXT,
            (SNOWFLAKE_TYPE_TEXT, 30, None, None),
            SNOWFLAKE_TYPE_TIME,
            SNOWFLAKE_TYPE_TIMESTAMP_NTZ,
            SNOWFLAKE_TYPE_TIMESTAMP_TZ,
        ]:
    ...
    def test_synapse_column(self):
        for data_type in [
            SYNAPSE_TYPE_BIGINT,
            SYNAPSE_TYPE_BINARY,
            (SYNAPSE_TYPE_BINARY, 16, None, None),
            SYNAPSE_TYPE_BIT,
            SYNAPSE_TYPE_CHAR,
            (SYNAPSE_TYPE_CHAR, 2, None, None),
            SYNAPSE_TYPE_DATE,
            SYNAPSE_TYPE_DATETIME,
            SYNAPSE_TYPE_DATETIME2,
            SYNAPSE_TYPE_DATETIMEOFFSET,
            SYNAPSE_TYPE_DECIMAL,
            (SYNAPSE_TYPE_DECIMAL, None, 20, 2),
            SYNAPSE_TYPE_FLOAT,
            SYNAPSE_TYPE_INT,
            SYNAPSE_TYPE_MONEY,
            SYNAPSE_TYPE_NCHAR,
            SYNAPSE_TYPE_NUMERIC,
            (SYNAPSE_TYPE_NUMERIC, None, 20, 2),
            SYNAPSE_TYPE_NVARCHAR,
            (SYNAPSE_TYPE_NVARCHAR, 30, None, None),
            SYNAPSE_TYPE_REAL,
            SYNAPSE_TYPE_SMALLDATETIME,
            SYNAPSE_TYPE_SMALLINT,
            SYNAPSE_TYPE_SMALLMONEY,
            ...
            SYNAPSE_TYPE_UNIQUEIDENTIFIER,
            SYNAPSE_TYPE_VARBINARY,
            (SYNAPSE_TYPE_VARBINARY, 30, None, None),
            SYNAPSE_TYPE_VARCHAR,
            (SYNAPSE_TYPE_VARCHAR, 30, None, None),
        ]:
            if isinstance(data_type, tuple):
                data_type, data_length, data_precision, data_scale = data_type
            else:
    ...
    def test_teradata_column(self):
        for data_type in [
            ...
            TERADATA_TYPE_BYTEINT,
            TERADATA_TYPE_CHAR,
            (TERADATA_TYPE_CHAR, 2, None, None),
            TERADATA_TYPE_CLOB,
            TERADATA_TYPE_DATE,
            TERADATA_TYPE_DECIMAL,
            (TERADATA_TYPE_DECIMAL, None, 10, None),
            (TERADATA_TYPE_DECIMAL, None, 20, 2),
            TERADATA_TYPE_DOUBLE,
            TERADATA_TYPE_INTEGER,
            TERADATA_TYPE_INTERVAL_YR,
            TERADATA_TYPE_INTERVAL_YM,
            ...
            TERADATA_TYPE_INTERVAL_SC,
            TERADATA_TYPE_NUMBER,
            (TERADATA_TYPE_NUMBER, None, 10, None),
            (TERADATA_TYPE_NUMBER, None, 20, 2),
            TERADATA_TYPE_SMALLINT,
            TERADATA_TYPE_TIME,
            (TERADATA_TYPE_TIME, None, None, 3),
            TERADATA_TYPE_TIMESTAMP,
            (TERADATA_TYPE_TIMESTAMP, None, None, 3),
            TERADATA_TYPE_TIME_TZ,
            TERADATA_TYPE_TIMESTAMP_TZ,
            TERADATA_TYPE_VARBYTE,
            TERADATA_TYPE_VARCHAR,
            (TERADATA_TYPE_VARCHAR, 30, None, None),
        ]:
            if isinstance(data_type, tuple):
                data_type, data_length, data_precision, data_scale = data_type
            else:
