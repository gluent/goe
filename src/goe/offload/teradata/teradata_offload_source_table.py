...
from goe.offload.teradata.teradata_frontend_api import teradata_get_primary_partition_expression
from goe.offload.teradata.teradata_partition_expression import TeradataPartitionExpression, \
