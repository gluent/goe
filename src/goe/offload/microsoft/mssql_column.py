...
class MSSQLColumn(ColumnMetadataInterface):
    ...
    def __init__(self, name, data_type, data_length=None, data_precision=None, data_scale=None, nullable=None,
                 ...
                 char_semantics=None):
        super(MSSQLColumn, self).__init__(name, data_type, data_length, data_precision, data_scale, nullable,
    ...
    def from_mssql(attribute_list):
        ...
        col = MSSQLColumn(name, data_type, data_length, data_precision, data_scale, nullable,
                          data_default, hidden, char_length)
        return col
    ...
    def format_data_type(self):
        ...
        elif self.data_type in [MSSQL_TYPE_CHAR, MSSQL_TYPE_VARCHAR, MSSQL_TYPE_NCHAR, MSSQL_TYPE_NVARCHAR]:
    ...
    def has_time_element(self):
        ...
        return bool(self.data_type in [MSSQL_TYPE_DATETIME2, MSSQL_TYPE_DATETIME,
                                       MSSQL_TYPE_SMALLDATETIME, MSSQL_TYPE_TIME])
    ...
    def is_number_based(self):
        ...
        """
        return bool(self.data_type.lower() in [MSSQL_TYPE_BIGINT, MSSQL_TYPE_BIT, MSSQL_TYPE_DECIMAL, MSSQL_TYPE_INT,
                                               MSSQL_TYPE_MONEY, MSSQL_TYPE_NUMERIC, MSSQL_TYPE_SMALLINT,
                                               MSSQL_TYPE_SMALLMONEY, MSSQL_TYPE_TINYINT,
                                               MSSQL_TYPE_FLOAT, MSSQL_TYPE_REAL])

    def is_date_based(self):
        """ Is the column date in class
        """
        return any(dt in self.data_type for dt in [MSSQL_TYPE_DATE, MSSQL_TYPE_DATETIME2, MSSQL_TYPE_DATETIME,
                                                   MSSQL_TYPE_DATETIMEOFFSET, MSSQL_TYPE_SMALLDATETIME])
    ...
    def is_string_based(self):
        ...
        """
        return bool(self.data_type.lower() in [MSSQL_TYPE_CHAR, MSSQL_TYPE_VARCHAR, MSSQL_TYPE_NCHAR,
                                               MSSQL_TYPE_NVARCHAR])
