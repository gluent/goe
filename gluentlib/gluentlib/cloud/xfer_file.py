...
# EXCEPTIONS
###############################################################################
class XferFileException(Exception): pass
...
DST_INVALID = "INVALID" # Destination file exists, but is invalid (needs to be re-copied)
    ...
    def equals(self, other):
        ...
        for stat in ("length", "checksum"):
            ...
            if self_val != other_val:
                logger.debug("Stat: %s mismatch between: %s [%s] and: %s [%s]" % \
