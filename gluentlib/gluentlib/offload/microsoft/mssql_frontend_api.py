...
from gluentlib.offload.microsoft.mssql_column import MSSQL_TYPE_VARCHAR, MSSQLColumn
from gluentlib.offload.microsoft.synapse_literal import SynapseLiteral
from gluentlib.offload.offload_constants import MSSQL_FRONTEND_CAPABILITIES
