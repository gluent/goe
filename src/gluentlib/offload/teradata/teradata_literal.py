...
from gluentlib.offload.teradata.teradata_column import TERADATA_TYPE_BYTE, TERADATA_TYPE_VARBYTE,\
...
class TeradataLiteral(FormatLiteralInterface):
    ...
    def format_literal(cls, python_value, data_type=None):
        ...
        def format_date_for_data_type(str_val, data_type):
            ...
            elif data_type == TERADATA_TYPE_TIMESTAMP_TZ and re.match(RE_TIMEZONE_NO_COLON, str_val):
