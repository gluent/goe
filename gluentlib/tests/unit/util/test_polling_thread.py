...
class TestPollingThread(TestCase):
    ...
    def test_OffloadTransportSqlStatsThread(self):
        ...
        test_payload = [[], [], [], [], [], [], [], [],
                        ...
                        [('8w3d3hhnz2m3v', 0, 5000, 0, 0, 1), ('bux0xas0983mu', 0, 5000, 0, 0, 1)],
                        [('8w3d3hhnz2m3v', 0, 45000, 0, 0, 1), ('bux0xas0983mu', 0, 35000, 0, 0, 1)],
                        [('8w3d3hhnz2m3v', 0, 170000, 0, 0, 1), ('bux0xas0983mu', 0, 160000, 0, 0, 1)],
                        [('8w3d3hhnz2m3v', 0, 221893, 0, 0, 1), ('bux0xas0983mu', 0, 301549, 0, 0, 1)],
                        [('8w3d3hhnz2m3v', 0, 298323, 0, 0, 1), ('bux0xas0983mu', 0, 359409, 0, 0, 1)]]
        ...
        test_thread = PollingThread(run_function=get_test_stats_function(test_payload),
