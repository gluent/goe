...
def frontend_testing_api_factory(frontend_type, connection_options, messages,
    ...
    if frontend_type == DBTYPE_ORACLE:
        from testlib.test_framework.oracle.oracle_frontend_testing_api import OracleFrontendTestingApi
        ...
        from testlib.test_framework.teradata.teradata_frontend_testing_api import TeradataFrontendTestingApi
        return TeradataFrontendTestingApi(frontend_type, connection_options, messages,
                                          existing_connection=existing_connection,
                                          dry_run=dry_run, do_not_connect=do_not_connect,
                                          trace_action=trace_action)
    elif frontend_type == DBTYPE_MSSQL:
        from testlib.test_framework.microsoft.mssql_frontend_testing_api import MSSQLFrontendTestingApi
