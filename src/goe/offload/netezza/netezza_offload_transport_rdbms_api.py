...
class OffloadTransportNetezzaApi(OffloadTransportRdbmsApiInterface):
    ...
    def __init__(
        ...
        self.debug(
            "OffloadTransportNetezzaApi setup: (%s, %s)"
    ...
    def get_rdbms_session_setup_commands(
        ...
        raise NotImplementedError(
            "Netezza get_rdbms_session_setup_commands() not implemented."
        )
    ...
    def get_transport_row_source_query(
        ...
        raise NotImplementedError(
            "Netezza get_transport_row_source_query() not implemented."
        )

    def get_transport_row_source_query_hint_block(self) -> str:
        raise NotImplementedError(
            "Netezza get_transport_row_source_query_hint_block() not implemented."
        )
