...
from gluentlib.offload.offload_source_table import OFFLOAD_PARTITION_TYPE_LIST, OFFLOAD_PARTITION_TYPE_RANGE
...
NODE_PARTITION_TYPES = {RANGE_NODE: OFFLOAD_PARTITION_TYPE_RANGE,
...
class TeradataPartitionExpression:
    def __init__(self, constraint_text: str):
        ...
        for range_node in fn_node.children[1:]:
            if range_node.data not in ('range_n_datetime_range', 'range_n_number_range'):
                continue
