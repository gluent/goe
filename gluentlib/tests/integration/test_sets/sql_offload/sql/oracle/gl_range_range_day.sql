...
create table gl_range_range_day
( id   integer
, data varchar2(30)
, dt   date
, num  number )
partition by range (dt)
subpartition by range (num)
subpartition template
( subpartition sp_1_3   values less than (4)
, subpartition sp_4_6   values less than (7)
, subpartition sp_7_9   values less than (10)
, subpartition sp_10_12 values less than (13) )
