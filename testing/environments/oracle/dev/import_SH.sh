...
dmpfile=SH_DEV.dmp
zipfile=${dmpfile}.gz
dmpurl=https://s3.amazonaws.com/gluent/SH_DEV.dmp.gz.7e5b6a814c550d2b99ca46df0601cf48
dmplog=import_SH_DEV.log
...
echo "Importing SH schema..."
impdp ${orauser} parfile=import_SH_DEV.par
check_return $? 0 "Import of SH schema has errors. See ${directory_path}/${dmplog} for details..."

echo "Cleaning up..."
rm ${directory_path}/${dmpfile}
check_return $? 0 "Unable to remove ${directory_path}/${dmpfile}..."

echo "Import of SH successfully completed."
