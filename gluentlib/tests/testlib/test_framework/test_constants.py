...
SET_SMOKE = 'smoke'
SET_SQLMON = 'sqlmon'
SET_SQL_CONNECTOR = 'sql-connector'
SET_SQL_CUSTOM = 'sql-custom'
SET_SQL_CUSTOMERS = 'sql-customers'
SET_SQL_FAP = 'sql-fap'
SET_SQL_JFPD = 'sql-jfpd'
SET_SQL_JFPD_UNIT = 'sql-jfpd-unit'
SET_SQL_JOIN_VIEW = 'sql-join-view'
SET_SQL_OFFLOAD = 'sql-offload'
SET_SQL_TPCDS = 'sql-tpcds'
SET_SQL_VIEWS = 'sql-views'
SET_STORIES = 'stories'
