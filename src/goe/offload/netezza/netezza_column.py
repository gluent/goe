...
class NetezzaColumn(ColumnMetadataInterface):
    ...
    def __init__(
        ...
        super(NetezzaColumn, self).__init__(
            name,
            data_type,
            data_length,
            data_precision,
    ...
    def format_data_type(self):
        raise NotImplementedError(
            "Netezza NetezzaColumn.format_data_type() not implemented."
        )
    ...
    def is_nan_capable(self):
        return bool(
            self.data_type in [NETEZZA_TYPE_DOUBLE_PRECISION, NETEZZA_TYPE_REAL]
        )
    ...
    def is_date_based(self):
        ...
        return any(
            dt in self.data_type for dt in [NETEZZA_TYPE_DATE, NETEZZA_TYPE_TIMESTAMP]
        )
