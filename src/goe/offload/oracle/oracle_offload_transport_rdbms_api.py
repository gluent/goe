...
from goe.offload.offload_transport_functions import get_rdbms_connection_for_oracle, split_ranges_for_id_range
...
from goe.offload.oracle.oracle_offload_source_table import oracle_version_supports_exadata
...
, (
    ...
    def get_rdbms_session_setup_commands(self, module, action, custom_session_parameters, include_fixed_sqoop=True,
        ...
        commands.extend(self._oracle_alter_session_statements(self._get_fixed_goe_parameters(), for_plsql=for_plsql,
                                                              include_semi_colons=include_semi_colons,
                                                              escape_semi_colons=escape_semi_colons))
