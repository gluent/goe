...
def offload_transport_rdbms_api_factory(rdbms_owner, rdbms_table_name, offload_options, messages,
    ...
    if offload_options.db_type == DBTYPE_ORACLE:
        from goe.offload.oracle.oracle_offload_transport_rdbms_api import OffloadTransportOracleApi
        ...
        from goe.offload.microsoft.mssql_offload_transport_rdbms_api import OffloadTransportMSSQLApi
        ...
        from goe.offload.netezza.netezza_offload_transport_rdbms_api import OffloadTransportNetezzaApi
        ...
        from goe.offload.teradata.teradata_offload_transport_rdbms_api import OffloadTransportTeradataApi
