...
from gluentlib.offload.bigquery.bigquery_column import BigQueryColumn, \
    BIGQUERY_TYPE_BIGNUMERIC, BIGQUERY_TYPE_BOOLEAN, BIGQUERY_TYPE_BYTES, BIGQUERY_TYPE_DATE, BIGQUERY_TYPE_DATETIME, \
    BIGQUERY_TYPE_FLOAT64, BIGQUERY_TYPE_INT64, BIGQUERY_TYPE_NUMERIC, BIGQUERY_TYPE_STRING, \
    BIGQUERY_TYPE_TIME, BIGQUERY_TYPE_TIMESTAMP
from gluentlib.offload.column_metadata import CanonicalColumn, match_table_column, \
...
from gluentlib.offload.microsoft.synapse_column import SynapseColumn, \
    SYNAPSE_TYPE_BIGINT, SYNAPSE_TYPE_BINARY, SYNAPSE_TYPE_BIT, SYNAPSE_TYPE_CHAR,\
    ...
    SYNAPSE_TYPE_NUMERIC, SYNAPSE_TYPE_NVARCHAR, SYNAPSE_TYPE_REAL,\
    SYNAPSE_TYPE_SMALLDATETIME, SYNAPSE_TYPE_SMALLINT, SYNAPSE_TYPE_SMALLMONEY,\
    SYNAPSE_TYPE_TIME, SYNAPSE_TYPE_TINYINT, SYNAPSE_TYPE_VARBINARY, SYNAPSE_TYPE_UNIQUEIDENTIFIER, SYNAPSE_TYPE_VARCHAR
from gluentlib.offload.microsoft.mssql_offload_source_table import MSSQLSourceTable
from gluentlib.offload.microsoft.mssql_column import MSSQLColumn, \
    MSSQL_TYPE_BIGINT, MSSQL_TYPE_BIT, MSSQL_TYPE_DECIMAL, MSSQL_TYPE_INT, \
    MSSQL_TYPE_MONEY, MSSQL_TYPE_NUMERIC, MSSQL_TYPE_SMALLINT, MSSQL_TYPE_SMALLMONEY, \
    MSSQL_TYPE_TINYINT, MSSQL_TYPE_FLOAT, MSSQL_TYPE_REAL, MSSQL_TYPE_DATE, \
    MSSQL_TYPE_DATETIME2, MSSQL_TYPE_DATETIME, \
    MSSQL_TYPE_SMALLDATETIME, MSSQL_TYPE_TIME, MSSQL_TYPE_CHAR, MSSQL_TYPE_VARCHAR, \
    MSSQL_TYPE_NCHAR, MSSQL_TYPE_NVARCHAR, MSSQL_TYPE_UNIQUEIDENTIFIER, \
    MSSQL_TYPE_TEXT, MSSQL_TYPE_NTEXT, MSSQL_TYPE_BINARY, MSSQL_TYPE_VARBINARY, \
    MSSQL_TYPE_IMAGE
from gluentlib.offload.netezza.netezza_column import NetezzaColumn, \
    NETEZZA_TYPE_BIGINT, NETEZZA_TYPE_INTEGER, NETEZZA_TYPE_SMALLINT, NETEZZA_TYPE_BYTEINT, \
    NETEZZA_TYPE_DOUBLE_PRECISION, NETEZZA_TYPE_REAL, NETEZZA_TYPE_NUMERIC, \
    NETEZZA_TYPE_TIME, NETEZZA_TYPE_TIMESTAMP, NETEZZA_TYPE_DATE, \
    NETEZZA_TYPE_CHARACTER_VARYING, NETEZZA_TYPE_CHARACTER, \
...
from gluentlib.offload.snowflake.snowflake_column import SnowflakeColumn, SNOWFLAKE_TYPE_BINARY,\
    SNOWFLAKE_TYPE_BOOLEAN, SNOWFLAKE_TYPE_DATE, SNOWFLAKE_TYPE_FLOAT, SNOWFLAKE_TYPE_NUMBER, SNOWFLAKE_TYPE_TEXT,\
...
from gluentlib.util.better_impyla import HADOOP_TYPE_BOOLEAN, HADOOP_TYPE_BIGINT, \
    HADOOP_TYPE_BINARY, HADOOP_TYPE_CHAR, HADOOP_TYPE_DATE, HADOOP_TYPE_DECIMAL, \
    HADOOP_TYPE_DOUBLE, HADOOP_TYPE_DOUBLE_PRECISION, HADOOP_TYPE_FLOAT, \
    HADOOP_TYPE_INT, HADOOP_TYPE_INTERVAL_DS, HADOOP_TYPE_INTERVAL_YM, \
    HADOOP_TYPE_REAL, HADOOP_TYPE_STRING, HADOOP_TYPE_SMALLINT, HADOOP_TYPE_TIMESTAMP, \
    HADOOP_TYPE_TINYINT, HADOOP_TYPE_VARCHAR
...
class TestDataTypeMappings(TestCase):
    ...
    def canonical_columns(self):
        return [
            ...
            CanonicalColumn('COL_FIXED_STR_2000', GLUENT_TYPE_FIXED_STRING, data_length=2000),
            CanonicalColumn('COL_FIXED_STR_2000_C', GLUENT_TYPE_FIXED_STRING, char_length=2000,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            CanonicalColumn('COL_FIXED_STR_2001', GLUENT_TYPE_FIXED_STRING, data_length=2001),
            CanonicalColumn('COL_FIXED_STR_2001_C', GLUENT_TYPE_FIXED_STRING, char_length=2001,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            CanonicalColumn('COL_FIXED_STR_1000_U', GLUENT_TYPE_FIXED_STRING, char_length=1000,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_UNICODE),
            CanonicalColumn('COL_FIXED_STR_1001_U', GLUENT_TYPE_FIXED_STRING, char_length=1001,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_UNICODE),
            CanonicalColumn('COL_LARGE_STR', GLUENT_TYPE_LARGE_STRING),
            CanonicalColumn('COL_VARIABLE_STR', GLUENT_TYPE_VARIABLE_STRING),
            CanonicalColumn('COL_VARIABLE_STR_4000', GLUENT_TYPE_VARIABLE_STRING, data_length=4000),
            CanonicalColumn('COL_VARIABLE_STR_4000_C', GLUENT_TYPE_VARIABLE_STRING, char_length=4000,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            CanonicalColumn('COL_VARIABLE_STR_4001', GLUENT_TYPE_VARIABLE_STRING, data_length=4001),
            CanonicalColumn('COL_VARIABLE_STR_4001_C', GLUENT_TYPE_VARIABLE_STRING, char_length=4001,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            CanonicalColumn('COL_VARIABLE_STR_2000_U', GLUENT_TYPE_VARIABLE_STRING, char_length=2000,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_UNICODE),
            CanonicalColumn('COL_VARIABLE_STR_2001_U', GLUENT_TYPE_VARIABLE_STRING, char_length=2001,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_UNICODE),
    ...
    def column_assertions(self, test_column, expected_column):
        ...
        def check(test_column, expected_column, attribute_name):
            msg = '%s.%s mismatch: %s != %s' % (test_column.name, attribute_name,
                                                getattr(test_column, attribute_name),
                                                getattr(expected_column, attribute_name))
            self.assertEqual(getattr(test_column, attribute_name), getattr(expected_column, attribute_name), msg)
    ...
    def validate_source_vs_expected_columns(self, source_columns, expected_columns):
        assert len(source_columns) == len(expected_columns), '%s != %s' % (len(source_columns), len(expected_columns))
        source_names = [_.name for _ in source_columns]
        expected_names = [_.name for _ in expected_columns]
        assert source_names == expected_names, 'Column name mismatch: %s != %s' % (source_names, expected_names)
...
class TestOracleDataTypeMappings(TestDataTypeMappings):
    ...
    def setUp(self):
        ...
        self.test_table_object = OracleSourceTable('no_user', 'no_table', self.options, messages, do_not_connect=True)

    def _get_rdbms_source_columns(self):
        return [
            # CHAR(100 BYTE)
            OracleColumn('COL_CHAR', ORACLE_TYPE_CHAR, char_length=100, data_length=100,
                         char_semantics=CANONICAL_CHAR_SEMANTICS_BYTE),
            # NCHAR(100 CHAR)
            OracleColumn('COL_NCHAR', ORACLE_TYPE_NCHAR, char_length=100, data_length=200,
                         char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            # VARCHAR2(1100 BYTE)
            OracleColumn('COL_VARCHAR2', ORACLE_TYPE_VARCHAR2, char_length=1100, data_length=1100,
                         char_semantics=CANONICAL_CHAR_SEMANTICS_BYTE),
            # NVARCHAR2(1100 CHAR)
            OracleColumn('COL_NVARCHAR2', ORACLE_TYPE_NVARCHAR2, char_length=1100, data_length=2200,
                         char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            # LOBS
            ...
            # NUMBER(2)
            OracleColumn('COL_NUMBER_2', ORACLE_TYPE_NUMBER, char_length=0, data_length=22,
                         data_precision=2, data_scale=0),
            # NUMBER(4)
            OracleColumn('COL_NUMBER_4', ORACLE_TYPE_NUMBER, char_length=0, data_length=22,
                         data_precision=4, data_scale=0),
            # NUMBER(9)
            OracleColumn('COL_NUMBER_9', ORACLE_TYPE_NUMBER, char_length=0, data_length=22,
                         data_precision=9, data_scale=0),
            # NUMBER(18)
            OracleColumn('COL_NUMBER_18', ORACLE_TYPE_NUMBER, char_length=0, data_length=22,
                         data_precision=18, data_scale=0),
            # NUMBER(38)
            OracleColumn('COL_NUMBER_38', ORACLE_TYPE_NUMBER, char_length=0, data_length=22,
                         data_precision=38, data_scale=0),
            # NUMBER
            OracleColumn('COL_NUMBER_NO_P_S', ORACLE_TYPE_NUMBER, char_length=0, data_length=22),
            # NUMBER(10,2)
            OracleColumn('COL_NUMBER_10_2', ORACLE_TYPE_NUMBER, char_length=0, data_length=22,
                         data_precision=10, data_scale=2),
            # FLOAT - in offload_source_table we blank out precision for FLOAT
            OracleColumn('COL_NUMBER_FLOAT', ORACLE_TYPE_FLOAT, data_length=22, data_precision=None),
            # Real numbers
            ...
            OracleColumn('COL_TIMESTAMP_TZ_6', ORACLE_TYPE_TIMESTAMP_TZ, data_length=13, data_scale=6),
            OracleColumn('COL_TIMESTAMP_TZ_9', ORACLE_TYPE_TIMESTAMP_TZ, data_length=13, data_scale=9),
            # INTERVAL DAY(9) TO SECOND(9)
            OracleColumn('COL_INTERVAL_DS', ORACLE_TYPE_INTERVAL_DS, data_length=11, data_precision=9, data_scale=9),
            # INTERVAL YEAR(9) TO MONTH
            OracleColumn('COL_INTERVAL_YM', ORACLE_TYPE_INTERVAL_YM, data_length=5, data_precision=9, data_scale=0),
        ]
    ...
    def test_oracle_to_canonical(self):
        ...
        expected_columns = [
            ...
            CanonicalColumn('COL_VARCHAR2', GLUENT_TYPE_VARIABLE_STRING, data_length=1100),
            CanonicalColumn('COL_NVARCHAR2', GLUENT_TYPE_VARIABLE_STRING, data_length=2200),
            ...
            CanonicalColumn('COL_NUMBER_10_2', GLUENT_TYPE_DECIMAL, data_precision=10, data_scale=2),
            CanonicalColumn('COL_NUMBER_FLOAT', GLUENT_TYPE_DECIMAL, data_precision=None, data_scale=None),
            CanonicalColumn('COL_FLOAT', GLUENT_TYPE_FLOAT),
            CanonicalColumn('COL_DOUBLE', GLUENT_TYPE_DOUBLE),
            ...
            CanonicalColumn('COL_TIMESTAMP_TZ_6', GLUENT_TYPE_TIMESTAMP_TZ, data_scale=6),
            CanonicalColumn('COL_TIMESTAMP_TZ_9', GLUENT_TYPE_TIMESTAMP_TZ, data_scale=9),
            CanonicalColumn('COL_INTERVAL_DS', GLUENT_TYPE_INTERVAL_DS),
            CanonicalColumn('COL_INTERVAL_YM', GLUENT_TYPE_INTERVAL_YM),
        ]
    ...
    def test_canonical_to_oracle(self):
        ...
        canonical_columns = [_ for _ in self.canonical_columns() if _.data_type != GLUENT_TYPE_BOOLEAN]
    ...
    def test_bigquery_to_oracle(self):
        backend_api = backend_api_factory(DBTYPE_BIGQUERY, FakeOpts(DBTYPE_ORACLE, target=DBTYPE_BIGQUERY),
                                          OffloadMessages(), do_not_connect=True)
        backend_columns = [
    ...
    def test_hive_to_oracle(self):
        backend_api = backend_api_factory(DBTYPE_HIVE, FakeOpts(DBTYPE_ORACLE, target=DBTYPE_HIVE),
                                          OffloadMessages(), do_not_connect=True)
        backend_columns = [
            ...
            HadoopColumn(name='COL_VARCHAR_2000_U', data_type=HADOOP_TYPE_VARCHAR, data_length=2000),
            HadoopColumn(name='COL_VARCHAR_2001_U', data_type=HADOOP_TYPE_VARCHAR, data_length=2001),
        ...
        expected_columns = [
            ...
            OracleColumn(name='COL_VARCHAR_4000', data_type=ORACLE_TYPE_VARCHAR2, data_length=4000),
            OracleColumn(name='COL_VARCHAR_4001', data_type=ORACLE_TYPE_CLOB),
            OracleColumn(name='COL_VARCHAR_2000_U', data_type=ORACLE_TYPE_NVARCHAR2, char_length=2000),
    ...
    def test_impala_to_oracle(self):
        backend_api = backend_api_factory(DBTYPE_IMPALA, FakeOpts(DBTYPE_ORACLE, target=DBTYPE_IMPALA),
                                          OffloadMessages(), do_not_connect=True)
        backend_columns = [
            HadoopColumn(name='COL_CHAR_255', data_type=HADOOP_TYPE_CHAR, data_length=255),
            HadoopColumn(name='COL_CHAR_255_U', data_type=HADOOP_TYPE_CHAR, data_length=255),
    ...
    def test_snowflake_to_oracle(self):
        backend_api = backend_api_factory(DBTYPE_SNOWFLAKE, FakeOpts(DBTYPE_ORACLE, target=DBTYPE_SNOWFLAKE),
                                          OffloadMessages(), do_not_connect=True)
        backend_columns = [
            SnowflakeColumn(name='COL_TEXT_4000', data_type=SNOWFLAKE_TYPE_TEXT, char_length=4000, data_length=16000),
            SnowflakeColumn(name='COL_TEXT_4001', data_type=SNOWFLAKE_TYPE_TEXT, char_length=4001, data_length=16004),
            SnowflakeColumn(name='COL_TEXT_2000_U', data_type=SNOWFLAKE_TYPE_TEXT, char_length=2000, data_length=8000),
            SnowflakeColumn(name='COL_TEXT_2001_U', data_type=SNOWFLAKE_TYPE_TEXT, char_length=2001, data_length=8004),
            SnowflakeColumn(name='COL_BINARY_2000', data_type=SNOWFLAKE_TYPE_BINARY, data_length=2000),
            SnowflakeColumn(name='COL_BINARY_2001', data_type=SNOWFLAKE_TYPE_BINARY, data_length=2001),
        ]
        expected_columns = [
            OracleColumn(name='COL_VARCHAR_4000', data_type=ORACLE_TYPE_VARCHAR2, char_length=4000,
                         char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            OracleColumn(name='COL_VARCHAR_4001', data_type=ORACLE_TYPE_CLOB),
            OracleColumn(name='COL_VARCHAR_2000_U', data_type=ORACLE_TYPE_NVARCHAR2, char_length=2000),
            OracleColumn(name='COL_VARCHAR_2001_U', data_type=ORACLE_TYPE_NCLOB),
    ...
    def test_synapse_to_oracle(self):
        backend_api = backend_api_factory(DBTYPE_SYNAPSE, FakeOpts(DBTYPE_ORACLE, target=DBTYPE_SYNAPSE),
                                          OffloadMessages(), do_not_connect=True)
        backend_columns = [
            SynapseColumn(name='COL_CHAR_2000', data_type=SYNAPSE_TYPE_CHAR, char_length=2000, data_length=2000),
            SynapseColumn(name='COL_CHAR_2001', data_type=SYNAPSE_TYPE_CHAR, char_length=2001, data_length=2001),
            SynapseColumn(name='COL_CHAR_1000_U', data_type=SYNAPSE_TYPE_CHAR, char_length=1000, data_length=1000),
            SynapseColumn(name='COL_CHAR_1001_U', data_type=SYNAPSE_TYPE_CHAR, char_length=1001, data_length=1001),
            SynapseColumn(name='COL_NCHAR_2000', data_type=SYNAPSE_TYPE_NCHAR, char_length=2000, data_length=4000),
            SynapseColumn(name='COL_NCHAR_2001', data_type=SYNAPSE_TYPE_NCHAR, char_length=2001, data_length=4002),
            SynapseColumn(name='COL_NCHAR_1000_U', data_type=SYNAPSE_TYPE_NCHAR, char_length=1000, data_length=2000),
            SynapseColumn(name='COL_NCHAR_1001_U', data_type=SYNAPSE_TYPE_NCHAR, char_length=1001, data_length=2002),
            SynapseColumn(name='COL_VARCHAR_4000', data_type=SYNAPSE_TYPE_VARCHAR, char_length=4000, data_length=4000),
            SynapseColumn(name='COL_VARCHAR_4001', data_type=SYNAPSE_TYPE_VARCHAR, char_length=4001, data_length=4001),
            SynapseColumn(name='COL_VARCHAR_2000_U', data_type=SYNAPSE_TYPE_VARCHAR,
                          char_length=2000, data_length=2000),
            SynapseColumn(name='COL_VARCHAR_2001_U', data_type=SYNAPSE_TYPE_VARCHAR,
                          char_length=2001, data_length=2001),
            SynapseColumn(name='COL_NVARCHAR_4000', data_type=SYNAPSE_TYPE_NVARCHAR,
                          char_length=4000, data_length=8000),
            SynapseColumn(name='COL_NVARCHAR_4001', data_type=SYNAPSE_TYPE_NVARCHAR,
                          char_length=4001, data_length=8001),
            SynapseColumn(name='COL_NVARCHAR_2000_U', data_type=SYNAPSE_TYPE_NVARCHAR,
                          char_length=2000, data_length=4000),
            SynapseColumn(name='COL_NVARCHAR_2001_U', data_type=SYNAPSE_TYPE_NVARCHAR,
                          char_length=2001, data_length=4001),
            ...
            SynapseColumn(name='COL_VARBINARY_2000', data_type=SYNAPSE_TYPE_VARBINARY, data_length=2000),
            SynapseColumn(name='COL_VARBINARY_2001', data_type=SYNAPSE_TYPE_VARBINARY, data_length=2001),
        ]
        expected_columns = [
            OracleColumn(name='COL_CHAR_2000', data_type=ORACLE_TYPE_CHAR, data_length=2000,
                         char_semantics=CANONICAL_CHAR_SEMANTICS_BYTE),
            OracleColumn(name='COL_CHAR_2001', data_type=ORACLE_TYPE_CLOB),
            OracleColumn(name='COL_CHAR_1000_U', data_type=ORACLE_TYPE_NCHAR, char_length=1000,
                         char_semantics=CANONICAL_CHAR_SEMANTICS_UNICODE),
            OracleColumn(name='COL_CHAR_1001_U', data_type=ORACLE_TYPE_NCLOB),
            OracleColumn(name='COL_NCHAR_2000', data_type=ORACLE_TYPE_CHAR, char_length=2000,
                         char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            OracleColumn(name='COL_NCHAR_2001', data_type=ORACLE_TYPE_CLOB),
            OracleColumn(name='COL_NCHAR_1000_U', data_type=ORACLE_TYPE_NCHAR, char_length=1000,
                         char_semantics=CANONICAL_CHAR_SEMANTICS_UNICODE),
            ...
            OracleColumn(name='COL_VARCHAR_2000_U', data_type=ORACLE_TYPE_NVARCHAR2, char_length=2000,
                         char_semantics=CANONICAL_CHAR_SEMANTICS_UNICODE),
            OracleColumn(name='COL_VARCHAR_2001_U', data_type=ORACLE_TYPE_NCLOB),
            OracleColumn(name='COL_NVARCHAR_4000', data_type=ORACLE_TYPE_VARCHAR2, char_length=4000,
                         char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            OracleColumn(name='COL_NVARCHAR_4001', data_type=ORACLE_TYPE_CLOB),
            OracleColumn(name='COL_NVARCHAR_2000_U', data_type=ORACLE_TYPE_NVARCHAR2, char_length=2000),
...
class TestMSSQLDataTypeMappings(TestDataTypeMappings):
    ...
    def setUp(self):
        ...
        messages = OffloadMessages()
        self.test_table_object = MSSQLSourceTable('no_user', 'no_table', self.options, messages, do_not_connect=True)
    ...
    def _get_rdbms_source_columns(self):
        return [
            ...
            MSSQLColumn('COL_UNIQ_ID', MSSQL_TYPE_UNIQUEIDENTIFIER, char_length=16, data_length=16),
            ...
            MSSQLColumn('COL_DECIMAL_2', MSSQL_TYPE_DECIMAL, char_length=0, data_length=5,
                        data_precision=2, data_scale=0),
            MSSQLColumn('COL_DECIMAL_4', MSSQL_TYPE_DECIMAL, char_length=0, data_length=5,
                        data_precision=4, data_scale=0),
            MSSQLColumn('COL_DECIMAL_9', MSSQL_TYPE_DECIMAL, char_length=0, data_length=5,
                        data_precision=9, data_scale=0),
            MSSQLColumn('COL_DECIMAL_18', MSSQL_TYPE_DECIMAL, char_length=0, data_length=9,
                        data_precision=18, data_scale=0),
            MSSQLColumn('COL_DECIMAL_38', MSSQL_TYPE_DECIMAL, char_length=0, data_length=17,
                        data_precision=38, data_scale=0),
            MSSQLColumn('COL_DECIMAL_10_2', MSSQL_TYPE_DECIMAL, char_length=0, data_length=9,
                        data_precision=10, data_scale=2),
            MSSQLColumn('COL_NUMERIC_2', MSSQL_TYPE_NUMERIC, char_length=0, data_length=5,
                        data_precision=2, data_scale=0),
            MSSQLColumn('COL_NUMERIC_4', MSSQL_TYPE_NUMERIC, char_length=0, data_length=5,
                        data_precision=4, data_scale=0),
            MSSQLColumn('COL_NUMERIC_9', MSSQL_TYPE_NUMERIC, char_length=0, data_length=5,
                        data_precision=9, data_scale=0),
            MSSQLColumn('COL_NUMERIC_18', MSSQL_TYPE_NUMERIC, char_length=0, data_length=9,
                        data_precision=18, data_scale=0),
            MSSQLColumn('COL_NUMERIC_38', MSSQL_TYPE_NUMERIC, char_length=0, data_length=17,
                        data_precision=38, data_scale=0),
            MSSQLColumn('COL_NUMERIC_10_2', MSSQL_TYPE_NUMERIC, char_length=0, data_length=9,
                        data_precision=10, data_scale=2),
            ...
            MSSQLColumn('COL_MONEY', MSSQL_TYPE_MONEY, char_length=0, data_length=8, data_scale=4),
            MSSQLColumn('COL_SMALLMONEY', MSSQL_TYPE_SMALLMONEY, char_length=0, data_length=4, data_scale=2),
    ...
    def test_mssql_to_canonical(self):
        ...
        expected_columns = [
            ...
            CanonicalColumn('COL_CHAR', GLUENT_TYPE_FIXED_STRING, data_length=100),
            CanonicalColumn('COL_NCHAR', GLUENT_TYPE_FIXED_STRING, data_length=200),
            CanonicalColumn('COL_VARCHAR', GLUENT_TYPE_VARIABLE_STRING, data_length=1100),
            CanonicalColumn('COL_NVARCHAR', GLUENT_TYPE_VARIABLE_STRING, data_length=2200),
            ...
            CanonicalColumn('COL_DECIMAL_10_2', GLUENT_TYPE_DECIMAL, data_precision=10, data_scale=2),
            ...
            CanonicalColumn('COL_NUMERIC_10_2', GLUENT_TYPE_DECIMAL, data_precision=10, data_scale=2),
...
class TestNetezzaDataTypeMappings(TestDataTypeMappings):
    ...
    def setUp(self):
        ...
        messages = OffloadMessages()
        self.test_table_object = NetezzaSourceTable('no_user', 'no_table', self.options, messages, do_not_connect=True)

    def _get_rdbms_source_columns(self):
        return [
            NetezzaColumn('COL_BOOLEAN', NETEZZA_TYPE_BOOLEAN),
            NetezzaColumn('COL_CHARACTER', NETEZZA_TYPE_CHARACTER, char_length=100, data_length=100),
            NetezzaColumn('COL_NCHARACTER', NETEZZA_TYPE_NATIONAL_CHARACTER, char_length=100, data_length=200),
            NetezzaColumn('COL_CHARACTERV', NETEZZA_TYPE_CHARACTER_VARYING, char_length=100, data_length=100),
            NetezzaColumn('COL_NCHARACTERV', NETEZZA_TYPE_NATIONAL_CHARACTER_VARYING, char_length=100, data_length=200),
            ...
            NetezzaColumn('COL_NUMERIC_2', NETEZZA_TYPE_NUMERIC, char_length=0, data_length=4,
                          data_precision=2, data_scale=0),
            NetezzaColumn('COL_NUMERIC_4', NETEZZA_TYPE_NUMERIC, char_length=0, data_length=4,
                          data_precision=4, data_scale=0),
            NetezzaColumn('COL_NUMERIC_9', NETEZZA_TYPE_NUMERIC, char_length=0, data_length=4,
                          data_precision=9, data_scale=0),
            NetezzaColumn('COL_NUMERIC_18', NETEZZA_TYPE_NUMERIC, char_length=0, data_length=8,
                          data_precision=18, data_scale=0),
            NetezzaColumn('COL_NUMERIC_38', NETEZZA_TYPE_NUMERIC, char_length=0, data_length=16,
                          data_precision=38, data_scale=0),
            NetezzaColumn('COL_NUMERIC_10_2', NETEZZA_TYPE_NUMERIC, char_length=0, data_length=16,
                          data_precision=10, data_scale=2),
    ...
    def test_netezza_to_canonical(self):
        ...
        expected_columns = [
            ...
            CanonicalColumn('COL_NCHARACTER', GLUENT_TYPE_FIXED_STRING, data_length=200),
            CanonicalColumn('COL_CHARACTERV', GLUENT_TYPE_VARIABLE_STRING, data_length=100),
            CanonicalColumn('COL_NCHARACTERV', GLUENT_TYPE_VARIABLE_STRING, data_length=200),
...
class TestBackendHiveDataTypeMappings(TestDataTypeMappings):
    ...
    def setUp(self):
        ...
        messages = OffloadMessages()
        self.test_api = backend_api_factory(self.options.target, self.options, messages, do_not_connect=True)
    ...
    def test_hive_to_canonical(self):
        ...
        expected_columns = [
            CanonicalColumn('COL_FIXED_STR', GLUENT_TYPE_FIXED_STRING, data_length=10),
            CanonicalColumn('COL_VARIABLE_STR', GLUENT_TYPE_VARIABLE_STRING),
            CanonicalColumn('COL_VARIABLE_STR2', GLUENT_TYPE_VARIABLE_STRING, data_length=10),
            CanonicalColumn('COL_BINARY', GLUENT_TYPE_BINARY),
            CanonicalColumn('COL_INT_1', GLUENT_TYPE_INTEGER_1),
            CanonicalColumn('COL_INT_2', GLUENT_TYPE_INTEGER_2),
            CanonicalColumn('COL_INT_4', GLUENT_TYPE_INTEGER_4),
...
class TestBackendBigQueryDataTypeMappings(TestDataTypeMappings):
    ...
    def test_bigquery_to_canonical(self):
        ...
        expected_columns = [
            ...
            CanonicalColumn('COL_BINARY', GLUENT_TYPE_BINARY),
            CanonicalColumn('COL_INT_8', GLUENT_TYPE_INTEGER_8),
            CanonicalColumn('COL_DEC_NO_P_S', GLUENT_TYPE_DECIMAL, data_precision=76, data_scale=38),
            CanonicalColumn('COL_DEC_10_2', GLUENT_TYPE_DECIMAL, data_precision=38, data_scale=9),
            CanonicalColumn('COL_DOUBLE', GLUENT_TYPE_DOUBLE),
            CanonicalColumn('COL_DATE', GLUENT_TYPE_DATE),
            CanonicalColumn('COL_DATETIME', GLUENT_TYPE_TIMESTAMP),
            CanonicalColumn('COL_TIME', GLUENT_TYPE_TIME),
...
class TestAvroDataTypeMappings(TestDataTypeMappings):
    ...
    def get_expected_staging_columns(self, target):
        ...
        return [
            ...
            StagingAvroColumn('COL_BINARY', AVRO_TYPE_STRING if stage_binary_as_string else AVRO_TYPE_BYTES),
            StagingAvroColumn('COL_BINARY_2000', AVRO_TYPE_STRING if stage_binary_as_string else AVRO_TYPE_BYTES),
            StagingAvroColumn('COL_BINARY_2001', AVRO_TYPE_STRING if stage_binary_as_string else AVRO_TYPE_BYTES),
            StagingAvroColumn('COL_LARGE_BINARY', AVRO_TYPE_STRING if stage_binary_as_string else AVRO_TYPE_BYTES),
    ...
    def test_canonical_to_avro_on_hive(self):
        ...
        staging_file = staging_file_factory('no_db', 'no_table', FILE_STORAGE_FORMAT_AVRO, self.canonical_columns(),
                                            self.options, False, messages, dry_run=True)
    ...
    def test_canonical_to_avro_for_snowflake(self):
        ...
        staging_file = staging_file_factory('no_db', 'no_table', FILE_STORAGE_FORMAT_AVRO, self.canonical_columns(),
                                            self.options, True, messages, dry_run=True)
        self._run_avro_column_tests(self.options.target, staging_file)
...
class TestParquetDataTypeMappings(TestDataTypeMappings):
    ...
    def get_expected_staging_columns(self, target):
        ...
        return [
            ...
            StagingParquetColumn('COL_BINARY', PARQUET_TYPE_STRING if stage_binary_as_string else PARQUET_TYPE_BINARY),
            StagingParquetColumn('COL_BINARY_2000', PARQUET_TYPE_STRING if stage_binary_as_string else PARQUET_TYPE_BINARY),
            StagingParquetColumn('COL_BINARY_2001', PARQUET_TYPE_STRING if stage_binary_as_string else PARQUET_TYPE_BINARY),
            StagingParquetColumn('COL_LARGE_BINARY', PARQUET_TYPE_STRING if stage_binary_as_string else PARQUET_TYPE_BINARY),
    ...
    def test_canonical_to_parquet_for_bigquery(self):
        messages = OffloadMessages()
        self.options.target = DBTYPE_BIGQUERY
        staging_file = staging_file_factory('no_db', 'no_table', FILE_STORAGE_FORMAT_PARQUET, self.canonical_columns(),
                                            self.options, False, messages, dry_run=True)
...
class TestBackendSnowflakeDataTypeMappings(TestDataTypeMappings):
    ...
    def test_snowflake_to_canonical(self):
        ...
        expected_columns = [
            ...
            CanonicalColumn('COL_INT_8', GLUENT_TYPE_INTEGER_8),
            CanonicalColumn('COL_INT_38', GLUENT_TYPE_INTEGER_38),
            CanonicalColumn('COL_DEC_20_10', GLUENT_TYPE_DECIMAL, data_precision=20, data_scale=10),
            CanonicalColumn('COL_DOUBLE', GLUENT_TYPE_DOUBLE),
            CanonicalColumn('COL_DATE', GLUENT_TYPE_DATE),
            CanonicalColumn('COL_TIME', GLUENT_TYPE_TIME),
            CanonicalColumn('COL_TIMESTAMP', GLUENT_TYPE_TIMESTAMP),
...
class TestBackendSynapseDataTypeMappings(TestDataTypeMappings):
    ...
    def _get_synapse_source_columns(self):
        return [
            ...
            SynapseColumn('COL_NVARCHAR_2001', SYNAPSE_TYPE_NVARCHAR, char_length=2001, data_length=4002),
            SynapseColumn('COL_NVARCHAR_4001', SYNAPSE_TYPE_NVARCHAR, char_length=4001, data_length=8002),
    ...
    def test_synapse_to_canonical(self):
        ...
        expected_columns = [
            ...
            CanonicalColumn('COL_BINARY', GLUENT_TYPE_BINARY),
            CanonicalColumn('COL_BINARY_2001', GLUENT_TYPE_BINARY, data_length=2001),
            CanonicalColumn('COL_CHAR', GLUENT_TYPE_FIXED_STRING, data_length=3,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_BYTE),
            CanonicalColumn('COL_CHAR_1001', GLUENT_TYPE_FIXED_STRING, data_length=1001,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_BYTE),
            CanonicalColumn('COL_CHAR_2001', GLUENT_TYPE_FIXED_STRING, data_length=2001,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_BYTE),
            CanonicalColumn('COL_DATE', GLUENT_TYPE_DATE),
            CanonicalColumn('COL_DATETIME', GLUENT_TYPE_TIMESTAMP),
            CanonicalColumn('COL_DATETIME2', GLUENT_TYPE_TIMESTAMP),
            ...
            CanonicalColumn('COL_INT', GLUENT_TYPE_INTEGER_4),
            CanonicalColumn('COL_MONEY', GLUENT_TYPE_DECIMAL, data_precision=19, data_scale=4),
            CanonicalColumn('COL_NCHAR', GLUENT_TYPE_FIXED_STRING, char_length=3,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            CanonicalColumn('COL_NCHAR_1001', GLUENT_TYPE_FIXED_STRING, char_length=1001,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            CanonicalColumn('COL_NCHAR_2001', GLUENT_TYPE_FIXED_STRING, char_length=2001,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            CanonicalColumn('COL_NVARCHAR', GLUENT_TYPE_VARIABLE_STRING, char_length=30,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            CanonicalColumn('COL_NVARCHAR_2001', GLUENT_TYPE_VARIABLE_STRING, char_length=2001,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            CanonicalColumn('COL_NVARCHAR_4001', GLUENT_TYPE_VARIABLE_STRING, char_length=4001,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_CHAR),
            CanonicalColumn('COL_SMALLDATETIME', GLUENT_TYPE_TIMESTAMP),
            CanonicalColumn('COL_SMALLINT', GLUENT_TYPE_INTEGER_2),
            CanonicalColumn('COL_SMALLMONEY', GLUENT_TYPE_DECIMAL, data_precision=10, data_scale=4),
            CanonicalColumn('COL_TIME', GLUENT_TYPE_TIME),
            ...
            CanonicalColumn('COL_VARCHAR', GLUENT_TYPE_VARIABLE_STRING, data_length=30,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_BYTE),
            CanonicalColumn('COL_VARCHAR_2001', GLUENT_TYPE_VARIABLE_STRING, data_length=2001,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_BYTE),
            CanonicalColumn('COL_VARCHAR_4001', GLUENT_TYPE_VARIABLE_STRING, data_length=4001,
                            char_semantics=CANONICAL_CHAR_SEMANTICS_BYTE),
        ]
        self.validate_source_vs_expected_columns(source_columns, expected_columns)
