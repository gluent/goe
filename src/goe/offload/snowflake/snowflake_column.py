...
LICENSE_TEXT
"""
from goe.offload.column_metadata import ColumnMetadataInterface, CANONICAL_CHAR_SEMANTICS_CHAR
...
class SnowflakeColumn(ColumnMetadataInterface):
    def __init__(self, name, data_type, data_length=None, data_precision=None, data_scale=None, nullable=None,
        ...
        super(SnowflakeColumn, self).__init__(name, data_type, data_length=data_length, data_precision=data_precision,
    ...
    def format_data_type(self):
        if self.data_type == SNOWFLAKE_TYPE_NUMBER:
            ...
            if self.data_length:
                ...
                return self.data_type
        elif (self.is_date_based() or self.data_type == SNOWFLAKE_TYPE_TIME) and self.data_scale is not None:
    ...
    def has_time_element(self):
        ...
        return bool(self.data_type in [SNOWFLAKE_TYPE_TIMESTAMP_NTZ, SNOWFLAKE_TYPE_TIMESTAMP_TZ, SNOWFLAKE_TYPE_TIME])
    ...
    def is_date_based(self):
        ...
        return bool(self.data_type in [SNOWFLAKE_TYPE_DATE, SNOWFLAKE_TYPE_TIMESTAMP_NTZ, SNOWFLAKE_TYPE_TIMESTAMP_TZ])
