...
def orchestration_repo_client_factory(connection_options, messages, dry_run=None):
    ...
    if connection_options.db_type == DBTYPE_ORACLE:
        from goe.persistence.oracle.oracle_orchestration_repo_client import OracleOrchestrationRepoClient
        ...
        from goe.persistence.teradata.teradata_orchestration_repo_client import TeradataOrchestrationRepoClient
