...
class TestBackendBigQueryDataTypeMappings(TestDataTypeMappings):
    ...
    def test_canonical_to_bigquery_unsafe_decimal(self):
        # Expected outcomes of source_columns when converted to BigQuery.
        canonical_columns = [
            # Should round up to max for NUMERIC.
            CanonicalColumn(
                "COL_DEC_10_2_UNSAFE",
                GOE_TYPE_DECIMAL,
                data_precision=10,
            ...
            # Should stay NUMERIC because 28 is not within padding digits of 38.
            CanonicalColumn(
                "COL_DEC_28_2_UNSAFE",
                GOE_TYPE_DECIMAL,
                data_precision=28,
            ...
            # Should switch to BIGNUMERIC because 37 is within padding digits of 38.
            CanonicalColumn(
                "COL_DEC_37_2_UNSAFE",
                GOE_TYPE_DECIMAL,
                data_precision=37,
            ...
            # Should switch to BIGNUMERIC because 8 is within padding digits of 9.
            CanonicalColumn(
                "COL_DEC_20_8_UNSAFE",
                GOE_TYPE_DECIMAL,
                data_precision=20,
