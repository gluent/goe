CREATE TABLE gl_part_range_dt_dt_pi_id
( id BIGINT
, dt DATE
, ts TIMESTAMP(0)
, ts_year INTEGER
...
PRIMARY INDEX (id)
PARTITION BY(
    RANGE_N(dt BETWEEN DATE '2018-01-01' AND DATE '2025-12-31' EACH INTERVAL '1' YEAR)
,   RANGE_N(dt BETWEEN DATE '2018-01-01' AND DATE '2025-12-31' EACH INTERVAL '1' MONTH)
);


INSERT INTO gl_part_range_dt_dt_pi_id
WITH v AS (
